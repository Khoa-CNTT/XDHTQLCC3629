    ...
    public function xacNhanDonHangDVVC(Request $request)
    {
        ...
        try {
            ...
            if ($donHangDangChonMail->tinh_trang == 5) {
               ...
               //link cua VietinBank// $link_qr  = "https://img.vietqr.io/image/ICB-108884357529-compact2.png?amount=" . $donHangDangChonMail->tong_tien . "&addInfo=TTDP" . str_replace('-', '', $donHangDangChonMail->ma_don_hang);;
