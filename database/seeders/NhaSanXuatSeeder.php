...
class NhaSanXuatSeeder extends Seeder
{
    public function run(): void
    {
        ...
        DB::table('nha_san_xuats')->insert([
            ...
            ['ten_cong_ty' => 'Hoà Phát Furniture', 'loai_doi_tac' =>  '1', 'dia_chi' => '643 Nguyễn Văn Cừ, quận Long Biên, Hà Nội, Việt Nam', 'so_dien_thoai' => '0912345680', 'email' => 'contact@hoaphat.com.vn','ngay_cap_nhat' => '2025-03-11','password' => bcrypt('123456'),'loai_tai_khoan' => 'Nhà Sản Xuất'],
